...

{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        borderPaint.setStyle(Paint.Style.FILL);
        borderPaint.setColor(0xaa000000);
        int innerWidth = width - mHorizontalPadding * 2;
        ...
        canvas.drawRect(new Rect(0, outInterval, mHorizontalPadding, height - outInterval), borderPaint);
        canvas.drawRect(new Rect(width - mHorizontalPadding, outInterval, width, height - outInterval), borderPaint);

        borderPaint.setStyle(Paint.Style.STROKE);
        borderPaint.setStrokeWidth(2);
        borderPaint.setColor(Color.RED);

        rect.offset(mHorizontalPadding, outInterval);
